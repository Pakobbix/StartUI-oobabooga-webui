...
import platform
import psutil
from PyQt5.QtWidgets import QApplication, QMessageBox, QMainWindow, QLabel, QVBoxLayout, QComboBox, QSlider, QCheckBox, QLineEdit, QFileDialog, QPushButton, QWidget, QListWidget, QListWidgetItem, QToolTip, QGridLayout, QRadioButton, QFrame
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        layout.addWidget(QLabel("Choose Wbits:"),2, 0)
        ...
        layout.addWidget(QLabel("Update the text-generation-webui:"), 4, 1)
        ...
        layout.addWidget(self.gpu_radio_button, 7, 0)
        ...
        layout.addWidget(self.cpu_radio_button, 7, 1)
        ...
        layout.addWidget(self.auto_radio_button, 7, 2)
        ...
        for i, gpu in enumerate(gpu_stats):
            ...
            layout.addWidget(gpu_label, 8 + i, 0)
            ...
            layout.addWidget(vram_slider, 8 + i, 1)
    
            vram_value_label = QLabel("0 GiB")
            layout.addWidget(vram_value_label, 8 + i, 3)
        ...
        self.ram_label.hide()
        layout.addWidget(self.ram_label, 8, 0)
        ...
        layout.addWidget(self.ram_slider, 8, 1)
    
        self.ram_value_label = QLabel("0 GiB")
        self.ram_value_label.hide()
        layout.addWidget(self.ram_value_label, 8, 3)
        ...
        layout.addWidget(QLabel("Pre-layer:"), 8 + len(gpu_stats), 0)
        ...
        layout.addWidget(self.pre_layer_value_label, 8 + len(gpu_stats), 3)
        ...
        line.setFrameShape(QFrame.HLine)
        line.setFrameShadow(QFrame.Sunken)
        layout.addWidget(line, 9 + len(gpu_stats), 0, 1, 3)
        ...
        layout.addWidget(self.use_8bit_checkbox, 10 + len(gpu_stats), 0)
        ...
        layout.addWidget(self.use_nostream_checkbox, 10 + len(gpu_stats), 1)
        ...
        layout.addWidget(self.use_16bit_checkbox, 11 + len(gpu_stats), 0)
        ...
        layout.addWidget(self.use_xformers_checkbox, 11 + len(gpu_stats), 1)
        ...
        layout.addWidget(self.use_trc_checkbox, 12 + len(gpu_stats), 0)
        ...
        layout.addWidget(self.use_monkey_checkbox, 12 + len(gpu_stats), 1)
        ...
        layout.addWidget(self.use_quant_checkbox, 13 + len(gpu_stats), 0)
        ...
        layout.addWidget(self.use_autotune_checkbox, 13 + len(gpu_stats), 1)
        ...
        layout.addWidget(self.authentication_checkbox, 14 + len(gpu_stats), 0)
        ...
        layout.addWidget(self.use_nocache_checkbox, 14 + len(gpu_stats), 1)

        # Add horizontal line to seperate the Checkboxes
        line = QFrame()
        line.setFrameShape(QFrame.HLine)
        line.setFrameShadow(QFrame.Sunken)
        layout.addWidget(line, 15 + len(gpu_stats), 0, 1, 3)
        ...
        layout.addWidget(self.choose_file_label, 16 + len(gpu_stats), 0)
        ...
        layout.addWidget(self.choose_file_button, 17 + len(gpu_stats), 0)

        # Extensions List
        self.extensions_list = QListWidget()
        self.extensions_list.setToolTip("Choose the extensions to be loaded.")
        layout.addWidget(QLabel("Choose Extensions:"), 18 + len(gpu_stats), 0)
        layout.addWidget(self.extensions_list, 18 + len(gpu_stats), 1)
        ...
        layout.addWidget(self.use_network_checkbox, 19 + len(gpu_stats), 0)
        ...
        layout.addWidget(self.listen_port_checkbox, 19 + len(gpu_stats), 1)
        ...
        layout.addWidget(self.listen_port_textfield, 20 + len(gpu_stats), 1)
        ...
        layout.addWidget(self.use_autolaunch_checkbox, 21 + len(gpu_stats), 0)
        ...
        layout.addWidget(self.use_autoclose_checkbox, 21 + len(gpu_stats), 1)
        ...
        layout.addWidget(self.start_button, 22 + len(gpu_stats), 0)

        self.save_button = QPushButton("Save Settings")
        self.save_button.setToolTip("You can Save your current Settings. Neat, isn't it?")
        self.save_button.clicked.connect(self.on_save_button_clicked)
        layout.addWidget(self.save_button, 23 + len(gpu_stats), 0)
        ...
        layout.addWidget(self.profile_name_textfield, 24 + len(gpu_stats), 0)
        ...
        layout.addWidget(QLabel("Choose Profile:"), 22 + len(gpu_stats), 1)
        layout.addWidget(self.profiles_dropdown, 24 + len(gpu_stats), 1)
        ...
        layout.addWidget(self.load_button, 23 + len(gpu_stats), 1)
    ...
    def on_update_button_clicked(self):
        run_cmd_with_conda(f"python webuiGUI.py --update")
